...
12. **Verified correlation reporting mismatch:** the unchanged `results/figures/task_gate_similarity_heatmap.png` labels NR-ER/NR-ER-LBD at approximately r = 0.25. The old REPORT.md and PDF generator claimed r = 0.65 (README claimed r > 0.6). Corrected the prose to weak positive similarity supported by the figure. This affects interpretability wording, not classifier metrics, predictions or model selection. No numerical correlation was recomputed.
